            ...
            <div class="section__panel block-form flex flex-col justify-center items-center">
                <form class="block-form__form form w-full flex flex-col">
                    ...
                    <div class="form__row row flex flex-col">
                        <a-input class="w-full row__item" v-model:value="username" name="username" placeholder="email" />
                        <div class="w-full row__item">
                            <a-input class="w-full row__item" v-model:value="email" name="email" placeholder="email" />
                    ...
                    <div class="form__row flex items-center">
                        <a-button type="primary" class="w-fit" :size="sizeButton">Зарегистрироваться</a-button>
